...
- **Owner:** Brand owner
- **Dependency:** None
- **Completion criteria:** Final images are approved for FIRST LIGHT, TOBACCO BLOOM, and WHITE MUSK, with an explicit mapping of each image to its product use.
...
- **Owner:** Website team
- **Dependency:** Tasks 1–3
- **Completion criteria:** Shipping, privacy, terms, returns/refunds, GST, business, support, and contact information are published and internally reviewed.
